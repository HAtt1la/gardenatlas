...
const translations = {
  en: {
    ...
    health_poor: 'Poor',
    health_bad: 'Critical',
    healthAllGood: 'All care tasks up to date',
    issueOverdue: 'Overdue',
    issueDueBy: 'Due by {date}',
    ...
    careProfilesDesc: 'Define care rules for plant types — spray, prune, water schedules',
    addCareProfile: 'Add profile',
    editCareProfile: 'Edit profile',
    deleteCareProfile: 'Delete profile',
    careProfileName: 'Profile name',
    careProfileDescription: 'Description',
    careProfileBuiltin: 'Built-in',
    careProfileRules: 'Rules',
    addRule: 'Add rule',
    editRule: 'Edit rule',
    deleteRule: 'Delete rule',
    ruleTrigger: 'Trigger',
    ruleAction: 'Action',
    ruleProduct: 'Product / treatment',
    rulePurpose: 'Purpose',
    ruleWindowDays: 'Window (days)',
    triggerSeason: 'Season (months)',
    triggerFlowering: 'After flowering',
    triggerSickness: 'After sickness recorded',
    triggerPruned: 'After pruning',
    actionSpray: 'Spray',
    actionPrune: 'Prune',
    actionWater: 'Water',
    careProfileSaved: 'Profile saved',
    careProfileDeleted: 'Profile deleted',
    careRuleSaved: 'Rule saved',
    careRuleDeleted: 'Rule deleted',
    assignProfile: 'Care profile',
    noProfile: 'No profile assigned',
    careProfileMonths: 'Months',
  ...
  hu: {
    ...
    // Plant health
    plantHealth: 'Növény egészsége',
    health_good: 'Jó',
    health_fair: 'Megfelelő',
    health_poor: 'Gyenge',
    health_bad: 'Kritikus',
    healthAllGood: 'Minden gondozási feladat naprakész',
    issueOverdue: 'Lejárt',
    issueDueBy: 'Határidő: {date}',
    ...
    // Care profiles
    careProfiles: 'Gondozási profilok',
    careProfilesDesc: 'Gondozási szabályok meghatározása növénytípusonként — permetezés, metszés, öntözés',
    addCareProfile: 'Profil hozzáadása',
    editCareProfile: 'Profil szerkesztése',
    deleteCareProfile: 'Profil törlése',
    careProfileName: 'Profil neve',
    careProfileDescription: 'Leírás',
    careProfileBuiltin: 'Beépített',
    careProfileRules: 'Szabályok',
    addRule: 'Szabály hozzáadása',
    editRule: 'Szabály szerkesztése',
    deleteRule: 'Szabály törlése',
    ruleTrigger: 'Kiváltó esemény',
    ruleAction: 'Teendő',
    ruleProduct: 'Termék / kezelés',
    rulePurpose: 'Cél',
    ruleWindowDays: 'Ablak (nap)',
    triggerSeason: 'Szezon (hónapok)',
    triggerFlowering: 'Virágzás után',
    triggerSickness: 'Betegség rögzítése után',
    triggerPruned: 'Metszés után',
    actionSpray: 'Permetezés',
    actionPrune: 'Metszés',
    actionWater: 'Öntözés',
    careProfileSaved: 'Profil mentve',
    careProfileDeleted: 'Profil törölve',
    careRuleSaved: 'Szabály mentve',
    careRuleDeleted: 'Szabály törölve',
    assignProfile: 'Gondozási profil',
    noProfile: 'Nincs profil rendelve',
    careProfileMonths: 'Hónapok',
